            ...
            {preview && (
                <div className="px-4 pt-3 flex items-center gap-3">
                    ...
                    <div className="relative">
                        ...
                        <button
                            onClick={handleCancelPreview}
                            className="absolute -top-2 -right-2 bg-gray-700 hover:bg-red-600 rounded-full p-0.5"
                        >
                            <X size={12} className="text-white" />
                        </button>
                    ...
                    <button
                        onClick={handleUpload}
                        disabled={uploading}
                        className="flex items-center gap-2 bg-violet-600 hover:bg-violet-700 disabled:opacity-50 text-white px-4 py-2 rounded-xl text-sm"
                    >
                        {uploading
                            ? <div className="w-4 h-4 border-2 border-white border-t-transparent rounded-full animate-spin" />
                            : <Send size={14} />
            ...
            <div className="p-4 flex gap-3 items-center relative">
                            ...
                            <div className="absolute bottom-12 left-0 z-20 bg-gray-900 border border-gray-700 rounded-2xl p-2 shadow-2xl flex flex-col gap-1 min-w-36">
                                ...
                                {mediaOptions.map(opt => (
                                    <button
                                        key={opt.type}
                                        onClick={() => opt.ref.current.click()}
                                        className={`flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm text-slate-300 hover:text-white ${opt.bg}`}
                                    >
                                        {opt.icon}
                                        {opt.label}
                                    </button>
                ...
                {editingMessage && (
                    <button
                        ...
                        className="bg-gray-700 hover:bg-gray-600 px-4 py-3 rounded-xl text-white"
                    >
                        Cancel
                    </button>
                )}
                ...
                <button
                    onClick={handleSubmit}
                    className={`px-4 py-3 rounded-xl transition-all ${editingMessage
