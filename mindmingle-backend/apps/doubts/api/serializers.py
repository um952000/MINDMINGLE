...
class DoubtSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'created_at', 'updated_at', 'images', 'reactions_summary', 'user_upvoted', 'user_downvoted'
        ]
...
class AnswerSerializer(serializers.ModelSerializer):
    ...
    doubt_title = serializers.CharField(
        source='doubt.title',
        read_only=True
    )
    ...
    class Meta:
        model = Answer
        fields = [
            'id', 'doubt', 'doubt_title', 'author', 'content', 'ai_summary', 'is_accepted',
            'parent', 'upvotes_count', 'downvotes_count', 'created_at', 'updated_at','user_upvoted', 'user_downvoted'
        ]
